...
public class SimpleFSM : MonoBehaviour {
	...
	// States of the Guard implemented as coroutine jobs
	private Job hear;
	private Job see;	
	private Job patrol;	
	...
	void EnterState(State stateEntered)
	{
		...
		case State.Investigate:
			...
			see = new Job(Seeing(player, sightAngle,sightDistance,sightMaxHeight,0.5f,true,() => {	Debug.Log ("Saw you!");
